    ...
    return (
      <Card className="max-w-xl mx-auto mt-6">
        ...
        <CardContent className="space-y-4">
          ...
          {error && <div className="text-red-500 font-medium border border-red-200 bg-red-50 rounded px-3 py-2">{error}</div>}
          ...
          {preview.length > 0 && (
            <div className="bg-gray-50 border rounded p-3">
              <div className="font-semibold mb-1 text-sm">Preview (first 5 rows):</div>
